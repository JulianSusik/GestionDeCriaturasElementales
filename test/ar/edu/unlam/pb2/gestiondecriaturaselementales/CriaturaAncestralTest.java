...
public class CriaturaAncestralTest {
	...
	@Test
	public void sePuedeEntrenarUnaCriaturaAncestralPasandoParametros() throws CriaturaYaExistenteException {
	...
	public void sePuedeEntrenarUnaCriaturaAncestral() throws CriaturaYaExistenteException {
		CriaturaElemental ance = new CriaturaAncestral("Dragon", Elementos.FUEGO, 100, EstadoEmocional.TRANQUILA);
		ance.entrenar();
		assertEquals(Integer.valueOf(110), ance.getNivelEnergia());
	}

	@Test(expected = LimiteEnergiaSuperadoException.class)
	public void noSePuedeEntrenarMasAllaDelNivel200DeEnergia() throws CriaturaYaExistenteException {
