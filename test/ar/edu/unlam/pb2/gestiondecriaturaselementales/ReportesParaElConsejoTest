...
public class ReportesParaElConsejoTest {
    ...
    public void queSePuedaContarLaCantidadDeCriaturasPorAfinidad() throws CriaturaYaExistenteException {
        ...
        CriaturaElemental criaturaTransformada1 = maestro1.transformarEnAscensoDelViento(criatura1);
        CriaturaElemental criaturaTransformada2 = maestro2.transformarEnAscensoDelViento(criatura2);
        
        Reportes reporte = new Reportes();
        Map<Elementos, Integer> criaturas = reporte.getCantidadDeCriaturasPorAfinidadElemental(Arrays.asList(maestro1, maestro2));
        assertEquals(null, criaturas.get(Elementos.AGUA));
        assertEquals(Integer.valueOf(1), criaturas.get(Elementos.FUEGO));
        assertEquals(Integer.valueOf(2), criaturas.get(Elementos.AIRE));
